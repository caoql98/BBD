...
def get_save_path(args):
    ...
    args.snapshot_path = '/code/BAM-main/exp/{}/{}/split{}/{}/snapshot'.format(args.data_set, args.arch, args.split, backbone_str)
    args.result_path = '/code/BAM-main/exp/{}/{}/split{}/{}/result'.format(args.data_set, args.arch, args.split, backbone_str)
